const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'multi-menu_first': 'Sub menu one',
    'multi-menu_first_child': 'Sub menu one child',
    'multi-menu_second': 'Sub menu two',
    'multi-menu_second_child': 'Sub menu two child',
    'multi-menu_second_child_home': 'Sub menu two child home',
    'advanced-modules': 'Advanced',
    'work-order': 'Work order',
    notify: 'Notifications',
    'company-address': 'Company address book',
    document: 'Document',
  ...
  page: {
    ...
    home: {
      ...
      projectCount: 'Work Orders',
      todo: 'Pending Notifications',
      message: 'History Notifications',
      workOrderTrend: '7-Day Work Order and Todo Trend',
      createdWorkOrder: 'New Work Orders',
      todoNotice: 'New Todo Notices',
      ...
      projectNews: {
        ...
        moreNews: 'More News',
        empty: 'No history notifications',
