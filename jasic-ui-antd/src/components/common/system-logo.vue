<template>
  <div class="app-logo">
    ...
    >
      ...
      <path
        d="M10 31 C27 28 47 26 66 27 C87 28 104 33 114 41 C118 44 120 47 120 49 C120 55 112 59 95 60 L35 60 C20 60 12 57 9 50 C8 46 8 39 10 31 Z"
        fill="url(#jasicBottom)"
      />
