...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    /**sysTypeCodeMenuMapper 依赖，用于协同完成当前业务流程中的数据访问、规则校验或状态处理。*/
    @Resource
     ...
     * 构建菜单Tree。
     *
     * @param menus menus，当前业务处理所需的输入值。
     * @return 业务处理结果
     */
     ...
     * 构建Children。
     *
     * @param parent parent，当前业务处理所需的输入值。
     * @param groupMap 业务映射数据，用于批量组装或快速查找。
     */
     ...
     * copyMenus。
     *
     * @param sourceSubjectType sourceSubjectType，当前业务处理所需的输入值。
     ...
     * 规范化类型Codes。
     *
     * @param targetTypeCodes 业务编码，用于匹配枚举、配置或外部系统数据。
     * @return 业务处理结果
     */
     ...
     *
     * @param subjectType subjectType，当前业务处理所需的输入值。
     * @param targetTypeCodeSet 业务编码，用于匹配枚举、配置或外部系统数据。
     * @return 业务处理结果
     */
     ...
     * 校验TargetTemplates。
     *
     * @param targetTemplateIdSet targetTemplateIdSet，当前业务处理所需的输入值。
     * @param targetTypeCodeSet 业务编码，用于匹配枚举、配置或外部系统数据。
     * @return 业务处理结果
     */
     ...
     * 同步菜单ToCompanies。
     *
     * @param templates templates，当前业务处理所需的输入值。
     * @return 业务处理结果
     */
     ...
     * 构建角色MapKey。
     *
     * @param roleKey roleKey，当前业务处理所需的输入值。
     * @return 业务处理结果
     */
    ...
    /**SyncStats 服务实现，负责业务校验、状态流转、数据持久化和跨模块协同。
...
@author Zoro*/
     ...
     * int字段。
     *
     * @param updatedRoleCount 时间值，用于业务节点记录或时效判断。
     * @param kickedUserCount 用户业务对象或用户相关值，用于操作人或归属判断。
     * @param skippedCompanyCount 公司业务对象或公司相关值，用于归属、权限或展示。
     * @return 业务处理结果
         */
        private final int updatedRoleCount;
        /**kickedUserCount 字段，用于当前类内部业务处理。*/
        private final int kickedUserCount;
        /**skippedCompanyCount 字段，用于当前类内部业务处理。*/
