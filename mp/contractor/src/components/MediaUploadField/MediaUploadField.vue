<template>
  <view>
    ...
    <uni-file-picker
      ...
      :mode="mode"
      :file-mediatype="filePickerMediatype"
      :limit="limit"
 ...
 */
  ...
  /**
 * uni-file-picker 对 mediatype 有字面量类型约束
 * @修改人 黄碧莲
 * @修改时间 2026-05-22
 */
  const filePickerMediatype = computed(() => props.fileMediatype as 'image' | 'video' | 'all')
